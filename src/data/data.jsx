...
export const sideBarLIst = [
  ...
  { icon: <DirectionsCarRoundedIcon />, text: "Users", path: "/users" },
  {
    icon: <CalendarMonthIcon />,
    text: "Appointments",
    path: "/appointments",
  },
  { icon: <PersonIcon />, text: "Offers", path: "/offers" },
  { icon: <RssFeedIcon />, text: "Blogs", path: "/blogs" },
  { icon: <RssFeedIcon />, text: "Shops & Operational hours", path: "/shops-&-operational-hours" },
  { icon: <RssFeedIcon />, text: "System Settings", path: "/sytem-settings" },
...
export const profileMenuList = [
  ...
  { icon: <img alt="" src={Person} />, text: "Users" },
  { icon: <img alt="" src={Calender} />, text: "Appointments" },
  { icon: <img alt="" src={Garage} />, text: "Offers" },
  { icon: <img alt="" src={Garage} />, text: "Blogs" },
  { icon: <img alt="" src={Garage} />, text: "Shops and Operation hours" },
  { icon: <img alt="" src={RefferVector} />, text: "System Settings" },
];
